public class Knoten {
    // Attribute
    /** 
     * Eine Zeichenkette, die den Inhalt des Knotens repräsentiert. Der Schlüssel des Knotens sozusagen.
     */
    String bezeichnung;
    ...
    /**
     *  Eine lästige Methode, die nur zur Darstellung auf der Konsole gebraucht wird.
     *  Sie gibt den Bezeichner des Knotenobjekts zurück, aber auf die angegebene Länge
     *  gekürzt (bzw. mit Leerzeichen aufgefüllt), damit bei der Ausgabe die Spalten
